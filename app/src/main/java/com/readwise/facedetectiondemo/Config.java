...
public class Config {
    ...
    public static String apiKey = "Yu3qtko6a1Lk73PIOcKm6iWC";
    public static String secretKey = "mIMGzLPSlNlLRWoBXdXdGInkFOHPk4NP";
    public static String licenseID = "readwise-baidu-sdk-face-android";
    ...
    public static String groupID = "Demo_01";
